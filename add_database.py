...
def add_database():
    ...
    ip1 = private_helper.make_interest_point('',[img1,img2,img3,img5],"Interest Point 1","This is a descriptions of something",geo_obj1,"Plants","Navy.png")
    ip2 = private_helper.make_interest_point('',[img4,img6],"Interest Point 2","This is a descriptions of something else",geo_obj2,"Animals","Green.png")
    ip3 = private_helper.make_interest_point('',[img7,img8],"Fish Ladder",ip3_description,geo_obj3,"Interest Points","Green.png")

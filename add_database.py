...
def add_database():
    ...
    ip1 = private_helper.make_interest_point('',[img1,img2,img3],"Interest Point 1","This is a descriptions of something",geo_obj1,"Plants","Navy.png")
    ip2 = private_helper.make_interest_point('',[img4],"Interest Point 2","This is a descriptions of something else",geo_obj2,"Animals","Green.png")

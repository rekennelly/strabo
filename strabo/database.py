'''
Currently handles interest point and image deletion.

In future versions, this will handle all database interactions,
including gets, sets, and updates. ***clarification needed*** Where are these interactions now
'''
